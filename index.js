...
const firebaseConfig = {
  ...
  authDomain: "unbiastext.firebaseapp.com",
  projectId: "unbiastext",
  storageBucket: "unbiastext.appspot.com",
...
app.post("/", async (req, res) => {
  ...
  if (biasOption == 0) {
    ...
    try {
      // prediction API call
      const predictionResponse = await axios.post(
        "http://127.0.0.1:5000/predictPolitical",
        {
          text: userInput,
        }
      );
...
exports.app = functions.https.onRequest(firebaseApp);
